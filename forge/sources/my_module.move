module forge::forge {
    ...
    //     id: UID,
    //     b: bool,
    //     u8Arr: vector<vector<u8>>,
    //     bArr: vector<bool>
    // }

    // public entry fun person(b:bool, u8Arr: vector<vector<u8>>, bArr: vector<bool>, ctx: &mut TxContext) {
    //     let person = Person {
    //         id: object::new(ctx),
    //         b,
    //         u8Arr,
    ...
    // public entry fun sword_create_2(forge: &mut Forge, nums: vector<u64>, recipient: address, ctx: &mut TxContext) {
    //     use sui::transfer;
    //
    //     let m :u64= vector::pop_back<u64>(&mut nums);
    //     // create a sword
    //     let sword = Sword {
    //         id: object::new(ctx),
    //         magic: m,
